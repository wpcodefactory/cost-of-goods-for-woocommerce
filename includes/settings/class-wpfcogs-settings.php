...
if ( ! class_exists( 'WPFCOGS_Settings' ) ) :

class WPFCOGS_Settings extends WC_Settings_Page {
	...
	function __construct() {
		...
		parent::__construct();
		// Sections
		require_once( 'class-wpfcogs-settings-section.php' );
		require_once( 'class-wpfcogs-settings-products.php' );
		require_once( 'class-wpfcogs-settings-orders.php' );
		require_once( 'class-wpfcogs-settings-shortcodes.php' );
		require_once( 'class-wpfcogs-settings-gateways.php' );
		require_once( 'class-wpfcogs-settings-shipping.php' );
		require_once( 'class-wpfcogs-settings-shipping-classes.php' );
		require_once( 'class-wpfcogs-settings-currencies.php' );
		require_once( 'class-wpfcogs-settings-tools.php' );
		require_once( 'class-wpfcogs-settings-analytics.php' );
		require_once( 'class-wpfcogs-settings-advanced.php' );
		require_once( 'class-wpfcogs-settings-compatibility.php' );
	...
	function sanitize_raw_parameter( $value, $option, $raw_value ) {
		if ( ! isset( $option['wpfcogs_raw'] ) || empty( $option['wpfcogs_raw'] ) ) {
			return $value;
		}
	...
	function add_promoting_notice() {
		...
		$promoting_notice->set_args( array(
			...
			'enable'                        => true === apply_filters( 'wpfcogs_settings', true ),
	...
	function save() {
		...
		global $current_section;
		do_action( 'wpfcogs_save_settings', $current_section );
	}
