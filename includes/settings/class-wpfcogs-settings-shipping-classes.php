...
if ( ! class_exists( 'WPFCOGS_Settings_Shipping_Classes' ) ) :

	class WPFCOGS_Settings_Shipping_Classes extends WPFCOGS_Settings_Section {
...
return new WPFCOGS_Settings_Shipping_Classes();
