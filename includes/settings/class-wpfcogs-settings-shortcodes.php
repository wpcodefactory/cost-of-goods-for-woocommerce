...
if ( ! class_exists( 'WPFCOGS_Settings_Shortcodes' ) ) :

	class WPFCOGS_Settings_Shortcodes extends WPFCOGS_Settings_Section {
		...
		function get_settings() {
			...
			$product_sc_opts = array(
				...
				array(
					'title'    => '[wpfcogs_product_profit]',
					'desc'     => __( 'Displays the product profit', 'cost-of-goods-for-woocommerce' ),
					'desc_tip' => __( 'Params:', 'cost-of-goods-for-woocommerce' ) . '' . '<br />' . wpfcogs_array_to_string( array(
							...
							'html_template'   => __( 'HTML template.', 'cost-of-goods-for-woocommerce' ) . ' ' . __( 'Default:', 'cost-of-goods-for-woocommerce' ) . ' <code>' . _wp_specialchars( '<span class="wpfcogs-product-profit">{content}</span>' ) . '</code>.',
				...
				array(
					'title'    => '[wpfcogs_product_cost]',
					'desc'     => __( 'Displays the product cost', 'cost-of-goods-for-woocommerce' ),
					'desc_tip' => __( 'Params:', 'cost-of-goods-for-woocommerce' ) . '' . '<br />' . wpfcogs_array_to_string( array(
							'product_id'    => __( 'Product ID.', 'cost-of-goods-for-woocommerce' ) . ' ' . __( 'If empty, will try to get the current product id.', 'cost-of-goods-for-woocommerce' ),
							'html_template' => __( 'HTML template.', 'cost-of-goods-for-woocommerce' ) . ' ' . __( 'Default:', 'cost-of-goods-for-woocommerce' ) . ' <code>' . _wp_specialchars( '<span class="wpfcogs-product-cost">{content}</span>' ) . '</code>.',
						), array( 'item_template' => '<li><code>{key}</code> - {value}', 'glue' => '<br /></li>' ) ),
...
return new WPFCOGS_Settings_Shortcodes();
