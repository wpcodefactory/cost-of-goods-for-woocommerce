...
if ( ! class_exists( 'WPFCOGS_Settings_Gateways' ) ) :

class WPFCOGS_Settings_Gateways extends WPFCOGS_Settings_Section {
	...
	function get_settings() {
		$settings = array(
			...
			array(
				...
				'default'  => wpfcogs_get_gateways_option_default(),
				'wpfse_data'    => array(
					'hide' => true
				)
			),
...
return new WPFCOGS_Settings_Gateways();
