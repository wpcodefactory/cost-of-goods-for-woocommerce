...
if ( ! class_exists( 'WPFCOGS_Settings_Products' ) ) :

class WPFCOGS_Settings_Products extends WPFCOGS_Settings_Section {
	...
	function get_settings() {
		$product_settings = array(
			...
			array(
				...
				'options'  => array(
					...
					'wpfcogs_get_regular_price' => __( 'Get regular price', 'cost-of-goods-for-woocommerce' ),
				),
				'wpfse_data' => array(
		...
		$cost_input_settings = array(
			...
			array(
				...
				'desc'       => __( 'Placeholders:', 'cost-of-goods-for-woocommerce' ) . ' ' . wpfcogs_array_to_string(
						wpfcogs()->core->cost_inputs->get_cost_input_label_placeholders( null ), array(
		...
		$add_stock_settings = array(
			array(
				...
				'desc'  => __( 'Calculate new average cost of goods for the product based on new "Stock" and "Cost" values you enter.', 'cost-of-goods-for-woocommerce' ) . '<br /><br />' .
				           ...
				           sprintf(
					           /* translators: %s: "Stock management" setting name in bold. */
					           __( 'The %s option has to be enabled.', 'cost-of-goods-for-woocommerce' ),
					           '<strong>' . __( 'Stock management', 'cost-of-goods-for-woocommerce' ) . '</strong>'
				           ),
				'type'  => 'title',
		...
		$cost_sanitization_opts = array(
			...
			array(
				...
				'default'  => wpfcogs_need_to_replace_cog_comma_by_dots_default(),
				'type'     => 'checkbox',
			),
			array(
...
return new WPFCOGS_Settings_Products();
