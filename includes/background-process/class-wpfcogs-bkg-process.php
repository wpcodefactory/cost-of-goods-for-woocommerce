...
if ( ! class_exists( 'WPFCOGS_Bkg_Process' ) ) :

	class WPFCOGS_Bkg_Process extends WP_Background_Process {
		...
		public function get_email_params() {
			$params = wp_parse_args( apply_filters( 'wpfcogs_bkg_process_email_params', $this->email_sending_params ), array(
