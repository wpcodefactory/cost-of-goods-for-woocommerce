...
(function ($, window, document) {
    ...
    $(document).on('ready', function () {
        ...
        let cogBetInput = $(".wpfcogs_bet_input");

        cogBetInput.on("focus", function () {
            $(this).closest("tr").addClass("wpfcogs_bet_active_row");
        });

        cogBetInput.on("focusout", function () {
            $(this).closest("tr").removeClass("wpfcogs_bet_active_row");
        });

        cogBetInput.on("change", function () {
            if ($(this).attr("initial-value") !== jQuery(this).val()) {
                $(this).closest("td").addClass("wpfcogs_bet_modified_row");
            } else {
                $(this).closest("td").removeClass("wpfcogs_bet_modified_row");
            }
        });
    });
