...
= 4.1.9 - 14/07/2026 =
* Fix - Fixed Order Extra costs.
* Fix - Fixed WooCommerce product import with incorrect prefix meta.

= 4.1.8 - 13/07/2026 =
* Fix - Fixed Cost Archive display.
* Fix - Fixed Add Stock variation history.
* Fix - Fixed Add Stock updating on variations.
...
= 4.1.2 - 08/05/2026 =
* Fix - Analytics - Fixed data inflation with the option "Orders > Extra Costs".

= 4.1.1 - 06/05/2026 =
* Fix - Improved sanitization in product cost/profit shortcodes.
* WC tested up to: 10.7.

= 4.1.0 - 12/03/2026 =
* Dev - Improved deploy mechanism.
* Fix - Fixed `.gitattributes`.
...
= 3.9.1 - 17/09/2025 =
* Fix - Analytics - Improved stock calculation.
* Fix - "Analytics > Categories" now considering Multicurrency section.
* Fix - Analytics - Fixed Multicurrency option with the Overview and Variations sections.
* Dev - Analytics - Stock - New option added to generate the CSV with the products selected by the Cost of Goods filter.

= 3.9.0 - 13/09/2025 =
* Fix - Fixed error where some orders could have the cost set as zero.

= 3.8.9 - 12/09/2025 =
* Fix - Advanced - Ignored order profit on the option "Avoid empty order metadata from being saved to database".
* Fix - "Analytics > Products" section now considering Multicurrency section.

= 3.8.8 - 09/09/2025 =
* Fix - Analytics - Improved stock calculation.

= 3.8.7 - 04/09/2025 =
* Fix - Fixed possible php warning on order updating.
...
= 3.8.2 - 19/08/2025 =
* Dev - Added Recommendations box on settings page via Cross-selling library.
* WC tested up to: 10.1.

= 3.8.1 - 11/08/2025 =
* Fix - Orders - Fixed admin order page sorting by ID and Date.

= 3.8.0 - 04/08/2025 =
* Dev - Compatibility - Added option to add Cost column to WBW Product Table plugin.
...
= 3.7.8 - 23/07/2025 =
* Dev - Extra costs from meta - Added option to treat extra costs from meta as profit instead of cost.
* Dev - Extra costs from meta - Code refactoring.
* Dev - Minified js and css automatically generated.

= 3.7.7 - 12/07/2025 =
* Fix - Analytics - Fixed inflated analytics.
...
* Dev - Now triggering `updated_post_meta` on Tools > Import even if From meta value is the same as new one.

= 3.7.1 - 08/05/2025 =
* Fix - Fixed vulnerability.

= 3.7.0 - 28/04/2025 =
* Dev - Add Stock - Added a remove button on the "Add stock feature" to delete a specific date from the history.
...
= 3.6.8 - 26/03/2025 =
* Dev - Analytics - Added cost and profit options for the Variations tab.
...
= 3.6.4 - 25/02/2025 =
* Dev - Multicurrency - Added new option to convert Extra Costs From Meta.

= 3.6.3 - 11/02/2025 =
* Fix - Orders - Extra costs - Fixed possible error "Call to a member function get_meta() on false" on a admin order page.
* Dev - Improved Composer loading.

= 3.6.2 - 28/01/2025 =
* Fix - Tools - Orders recalculation - Fixed date options.
* Dev - Tools - Orders recalculation - New option added to override item costs on recalculation.
* WC tested up to: 9.6.

[View older changelog entries](https://plugins.svn.wordpress.org/cost-of-goods-for-woocommerce/trunk/changelog-older.txt)
